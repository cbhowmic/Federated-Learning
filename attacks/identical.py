...
def bulyan(grad_stck, grad_avg, target_idx=-1, **kwargs):
  ...
  if target_idx == "all":
    ...
    # print(grad_att.size())
    # res = grad_att.argmax(axis=0)
    # print('index:', res)
    # print('grad_att', torch.sum(grad_att))
    return grad_att

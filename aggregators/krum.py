...
def _compute_scores(gradients, f, **kwargs):
...
def aggregate(gradients, f, **kwargs):
  ...
  scores = _compute_scores(gradients, f, **kwargs)
  # print('score 0', scores[0], 'score 1', scores[1])
  _, grad = scores[0]
  return grad
  # return (grad for _, grad in scores[:1])
